...
<div class="public-shell">
  ...
  <main class="public-main">
    <section class="card">
      <h1><fmt:message key="privacy.header"/></h1>
      <p><fmt:message key="privacy.updated"/></p>

      <h2><fmt:message key="privacy.collect.title"/></h2>
      <p><fmt:message key="privacy.collect.text"/></p>

      <h2><fmt:message key="privacy.use.title"/></h2>
      <p><fmt:message key="privacy.use.text"/></p>

      <h2><fmt:message key="privacy.bank.title"/></h2>
      <p><fmt:message key="privacy.bank.text"/></p>

      <h2><fmt:message key="privacy.delete.title"/></h2>
      <p><fmt:message key="privacy.delete.text"/></p>

      <h2><fmt:message key="privacy.contact.title"/></h2>
      <p><fmt:message key="privacy.contact.text"/></p>
