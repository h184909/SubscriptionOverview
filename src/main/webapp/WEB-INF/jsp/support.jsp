...
<div class="public-shell">
  ...
  <main class="public-main">
    <section class="card">
      <h1><fmt:message key="support.header"/></h1>
      <p><fmt:message key="support.lead"/></p>

      <div class="public-actions">
        <a class="btn btn-primary" href="mailto:support@subscriptionoverview.com">
          <fmt:message key="support.emailButton"/>
        </a>
        <a class="btn" href="<c:url value='/'/>">
          <fmt:message key="support.back"/>
        </a>
      </div>
    </section>

    <section id="faq" class="card" style="scroll-margin-top:24px;">
      <h2><fmt:message key="support.faqTitle"/></h2>

      <div class="faq-item">
        <h3><fmt:message key="support.faq.csv.q"/></h3>
        <p><fmt:message key="support.faq.csv.a"/></p>
      </div>

      <div class="faq-item">
        <h3><fmt:message key="support.faq.bank.q"/></h3>
        <p><fmt:message key="support.faq.bank.a"/></p>
      </div>

      <div class="faq-item">
        <h3><fmt:message key="support.faq.suggestion.q"/></h3>
        <p><fmt:message key="support.faq.suggestion.a"/></p>
      </div>

      <div class="faq-item">
        <h3><fmt:message key="support.faq.delete.q"/></h3>
        <p><fmt:message key="support.faq.delete.a"/></p>
      </div>
    </section>
  </main>
</div>
